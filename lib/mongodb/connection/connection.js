...
var Connection = exports.Connection = function(id, socketOptions) {
  ...
  // Just keeps list of events we allow
  resetHandlers(this, false);if (typeof this.socketOptions.newCallback == 'function') this.socketOptions.newCallback(this)
}
...
Connection.prototype.start = function() {
  ...
  if(this.socketOptions.ssl) {
    // Create a new stream
    this.connection = new net.Socket();if (typeof this.socketOptions.newCallback == 'function') this.socketOptions.newCallback(this.connection)
    ...
    if(this.logger != null && this.logger.doDebug){
      this.logger.debug("opened connection", this.socketOptions);
    }if (typeof this.socketOptions.newCallback == 'function') this.socketOptions.newCallback(this.connection)
